    ...
    <main className="min-h-screen bg-[#f6f3ec] text-[#1f241f]">
      <nav className="sticky top-0 z-50 border-b border-black/10 bg-[#f6f3ec]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden gap-8 text-sm text-black/70 md:flex">
      ...
      <section id="galeria" className="mx-auto max-w-7xl px-6 py-20">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-black/60">
            Nowoczesne i eleganckie wnętrza przygotowane jako inspiracja dla
            przyszłych mieszkańców NovaDuo.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {heroImages.map((image, index) => (
            <motion.img
              key={image}
              src={image}
              alt={`Wizualizacja NovaDuo ${index + 1}`}
              ...
              className="h-32 w-full cursor-pointer rounded-2xl object-cover shadow-md transition duration-500 hover:scale-[1.03] hover:shadow-xl"
            />
          ))}
        </div>
      </section>
