...
export const metadata = {
  title: "Nowe domy pod Warszawą na sprzedaż | NovaDuo",
  description:
    "Nowe domy pod Warszawą w inwestycji NovaDuo w Pogroszewie. Przestronne lokale z garażem, prywatnym ogrodem, pompą ciepła i rekuperacją.",
  keywords: [
    "domy pod Warszawą",
    "domy pod Warszawą na sprzedaż",
    "nowe domy pod Warszawą",
    "dom z ogrodem pod Warszawą",
    "dom z garażem pod Warszawą",
    "dom dla rodziny pod Warszawą",
    "domy zachodnia Warszawa",
    "domy Pogroszew",
    "domy Ożarów Mazowiecki",
    "NovaDuo",
  ],
  alternates: {
    canonical: "https://www.jpjconcept.pl/domy-pod-warszawa",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Nowe domy pod Warszawą na sprzedaż | NovaDuo",
    description:
      "Kameralna inwestycja NovaDuo w Pogroszewie: przestronne lokale z garażem, prywatnym ogrodem, pompą ciepła i rekuperacją.",
    url: "https://www.jpjconcept.pl/domy-pod-warszawa",
    ...
    images: [
      {
        ...
        alt: "Nowe domy NovaDuo pod Warszawą",
      },
    ],
  },
};
...
const galleryImages = [
  ...
  },
  {
    ...
    alt: "Kameralne domy pod Warszawą",
  },
  {
  ...
  },
  {
    ...
    alt: "Nowoczesna zabudowa NovaDuo pod Warszawą",
  },
  {
...
const faq = [
  {
    ...
    answer:
      "Inwestycja NovaDuo znajduje się przy ul. Nowowiejskiej 58 w Pogroszewie, w gminie Ożarów Mazowiecki, w zachodniej części aglomeracji warszawskiej.",
  },
  {
    question: "Ile lokali powstaje w inwestycji?",
    answer:
      "NovaDuo składa się z czterech budynków dwulokalowych, czyli łącznie ośmiu lokali mieszkalnych.",
  },
  {
...
export default function DomyPodWarszawaPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Nowe domy pod Warszawą – NovaDuo Pogroszew",
    description:
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.jpjconcept.pl/domy-pod-warszawa",
      },
    ],
  };
      ...
      <nav className="sticky top-0 z-50 border-b border-black/10 bg-[#f6f3ec]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-7 text-sm text-black/65 md:flex">
            ...
            <a href="#dlaczego">Dlaczego warto</a>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:py-28">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.04] tracking-tight md:text-7xl">
              Nowe domy pod Warszawą z ogrodem i garażem
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/65">
              NovaDuo to kameralna inwestycja w Pogroszewie dla osób
              poszukujących przestronnego domu pod Warszawą, prywatnego
              ogrodu, garażu oraz nowoczesnych instalacji.
            </p>
      ...
      >
        <div className="mb-14 max-w-4xl">
          ...
          <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
            Więcej przestrzeni niż w mieszkaniu
          </h2>
          ...
          <div className="mt-7 space-y-5 text-lg leading-8 text-black/70">
            <p>
              ...
              wejście, garaż w bryle budynku oraz przestrzeń ogrodową
              przeznaczoną do wyłącznego użytkowania.
            </p>

            <p>
              Dwie kondygnacje ułatwiają oddzielenie wspólnej części dziennej
              od prywatnej strefy sypialnianej. Dodatkową przestrzeń można
              wykorzystać również do pracy z domu, przechowywania lub
              urządzenia pokoju gościnnego.
            </p>

            <p>
              Inwestycja powstaje w Pogroszewie, w gminie Ożarów Mazowiecki,
              dzięki czemu łączy spokojniejsze otoczenie z dostępem do
              infrastruktury zachodniej części aglomeracji warszawskiej.
            </p>
          </div>
        </div>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2">
          <div>
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Dom z ogrodem w spokojniejszym otoczeniu
            </h2>
          </div>

          <div className="space-y-5 text-lg leading-8 text-white/75">
            <p>
              Prywatny ogród daje miejsce do wypoczynku, zabawy dzieci,
              spotkań z rodziną i urządzenia własnej zielonej przestrzeni.
            </p>

            <p>
              Garaż w bryle budynku ułatwia codzienne parkowanie i zapewnia
              dodatkowe miejsce do przechowywania.
            </p>

            <p>
              Kameralna liczba lokali odróżnia NovaDuo od dużych osiedli i
              pozwala zachować bardziej prywatny charakter inwestycji.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Nowoczesne instalacje w każdym lokalu
            </h2>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Pogroszew w zachodniej części aglomeracji warszawskiej
            </h2>
          ...
          <div className="overflow-hidden rounded-[2rem] bg-white shadow-2xl">
            <iframe
              title="Lokalizacja domów NovaDuo pod Warszawą"
      ...
      <section id="galeria" className="scroll-mt-36 bg-white/60 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-14 text-center">
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Zobacz budynki i przykładowe wnętrza
            </h2>

            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-black/60">
              Wizualizacje przedstawiają charakter inwestycji oraz przykładowe
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Link
              ...
              className="rounded-3xl border border-[#1f3d2b]/10 bg-[#f6f3ec] p-7 transition hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="text-sm uppercase tracking-[0.2em] text-[#1f3d2b]/60">
                Zobacz również
              </div>
            ...
            <Link
              ...
              className="rounded-3xl border border-[#1f3d2b]/10 bg-[#e4e6d7] p-7 transition hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="text-sm uppercase tracking-[0.2em] text-[#1f3d2b]/60">
                Lokalizacja
              </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-2">
          ...
          >
            <input
              type="hidden"
              name="source"
              value="Podstrona: domy pod Warszawą"
            />
