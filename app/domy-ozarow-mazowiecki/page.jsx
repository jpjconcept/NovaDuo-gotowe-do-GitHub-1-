...
export const metadata = {
  title: "Domy Ożarów Mazowiecki na sprzedaż | NovaDuo Pogroszew",
  description:
    "Nowe domy w gminie Ożarów Mazowiecki. NovaDuo w Pogroszewie oferuje przestronne lokale z garażem, prywatnym ogrodem, pompą ciepła i rekuperacją.",
  keywords: [
    "domy Ożarów Mazowiecki",
    "domy na sprzedaż Ożarów Mazowiecki",
    "nowe domy Ożarów Mazowiecki",
    "domy w gminie Ożarów Mazowiecki",
    "domy Pogroszew",
    "segmenty Ożarów Mazowiecki",
    "bliźniaki Ożarów Mazowiecki",
    "dom z ogrodem Ożarów Mazowiecki",
    "NovaDuo",
  ],
  alternates: {
    canonical: "https://www.jpjconcept.pl/domy-ozarow-mazowiecki",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Domy Ożarów Mazowiecki na sprzedaż | NovaDuo",
    description:
      "Kameralna inwestycja NovaDuo w Pogroszewie, w gminie Ożarów Mazowiecki: garaż, ogród, pompa ciepła i rekuperacja.",
    url: "https://www.jpjconcept.pl/domy-ozarow-mazowiecki",
    siteName: "NovaDuo | JPJ Concept",
    locale: "pl_PL",
    type: "website",
    images: [
      {
        url: "/images/postprodukcja_0003_Scene-3_upscale01.png",
        width: 1200,
        height: 630,
        alt: "Domy NovaDuo w gminie Ożarów Mazowiecki",
      },
    ],
  },
};
...
const advantages = [
  {
    ...
    description:
      "Przestronna powierzchnia i funkcjonalny układ pomieszczeń dla całej rodziny.",
  },
  {
    icon: Car,
    title: "Garaż w bryle",
  ...
  },
  {
    ...
    description:
      "Przestrzenie ogrodowe przeznaczone do wyłącznego użytkowania od 255 do 424 m².",
  },
  {
    icon: Home,
...
const galleryImages = [
  {
    ...
    alt: "Nowe domy NovaDuo w gminie Ożarów Mazowiecki",
  },
  {
    src: "/images/postprodukcja_0001_Scene-7_upscale01.png",
    alt: "Domy z garażami w inwestycji NovaDuo",
  },
  {
  ...
  },
  {
    ...
    alt: "Kameralne domy w gminie Ożarów Mazowiecki",
  },
  {
    src: "/images/postprodukcja_0004_Scene-4_upscale01.png",
    alt: "Domy z prywatnymi ogrodami NovaDuo",
  },
  {
    src: "/images/postprodukcja_0005_Scene-5_upscale01.png",
    alt: "Nowoczesna zabudowa NovaDuo w Pogroszewie",
  },
  {
  ...
  },
  {
    ...
    alt: "Przykładowa aranżacja przestronnego domu NovaDuo",
  },
];
...
const faq = [
  {
    ...
    answer:
      "NovaDuo powstaje przy ul. Nowowiejskiej 58 w Pogroszewie, na terenie gminy Ożarów Mazowiecki. Inwestycja nie znajduje się w centrum miasta Ożarów Mazowiecki, lecz w spokojniejszej miejscowości należącej do tej gminy.",
  },
  {
    question: "Ile domów i lokali powstaje w inwestycji?",
    answer:
      "Inwestycja składa się z czterech budynków dwulokalowych, czyli łącznie ośmiu lokali mieszkalnych.",
  },
  {
  ...
  {
    question: "Jakie ogrzewanie zastosowano w NovaDuo?",
    answer:
  ...
  {
    question: "Czy lokale posiadają rekuperację?",
    answer:
...
export default function DomyOzarowMazowieckiPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Domy Ożarów Mazowiecki – NovaDuo Pogroszew",
    description:
      "Nowe lokale w budynkach dwulokalowych z garażem, prywatnym ogrodem, pompą ciepła i rekuperacją w Pogroszewie, w gminie Ożarów Mazowiecki.",
    url: "https://www.jpjconcept.pl/domy-ozarow-mazowiecki",
    inLanguage: "pl-PL",
    isPartOf: {
      "@type": "WebSite",
    ...
    about: {
      ...
      name: "NovaDuo",
      image:
        "https://www.jpjconcept.pl/images/postprodukcja_0003_Scene-3_upscale01.png",
      address: {
        "@type": "PostalAddress",
  ...
  const breadcrumbStructuredData = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Domy Ożarów Mazowiecki",
        item: "https://www.jpjconcept.pl/domy-ozarow-mazowiecki",
      },
    ],
  };
  ...
  return (
    <main className="min-h-screen bg-[#f6f3ec] text-[#1f241f]">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:py-28">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/65">
              ...
              w Pogroszewie. Oferuje przestronne lokale z garażem, prywatnym
              ogrodem, pompą ciepła i rekuperacją, położone na terenie gminy
              Ożarów Mazowiecki.
            </p>
      ...
      >
        <div className="mb-14 max-w-4xl">
          ...
          <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
            Przestronny dom w kameralnej inwestycji
          </h2>
          ...
          <div className="mt-7 space-y-5 text-lg leading-8 text-black/70">
            ...
            <p>
              Inwestycja znajduje się w Pogroszewie, na terenie gminy Ożarów
              Mazowiecki. Jest to propozycja dla osób poszukujących domu w tej
              części powiatu warszawskiego zachodniego, ale preferujących
              spokojniejsze otoczenie poza zwartą zabudową miasta.
            </p>

            <p>
              Duża powierzchnia, dwie kondygnacje, własny ogród i garaż
              pozwalają wygodnie zorganizować codzienne życie rodzinne oraz
              pracę z domu.
            </p>
          </div>
        </div>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2">
          <div>
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Spokojniejsze otoczenie z dostępem do infrastruktury
            </h2>
          </div>

          <div className="space-y-5 text-lg leading-8 text-white/75">
            <p>
              Pogroszew należy do gminy Ożarów Mazowiecki i znajduje się w
              zachodniej części aglomeracji warszawskiej.
            </p>

            <p>
              Mieszkańcy mogą korzystać z infrastruktury gminy, w tym szkół,
              przedszkoli, sklepów i usług, pozostając jednocześnie w otoczeniu
              zabudowy jednorodzinnej i terenów zielonych.
            </p>

            <p>
              Lokalizacja pozwala połączyć codzienny komfort domu z dostępem do
              głównych tras komunikacyjnych prowadzących w kierunku Warszawy.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-[#e4e6d7] p-8">
            <School className="mb-5 h-8 w-8 text-[#1f3d2b]" />
            <h3 className="text-2xl font-semibold">Edukacja</h3>
            <p className="mt-3 leading-7 text-black/65">
              Dostęp do placówek edukacyjnych funkcjonujących na terenie gminy
              Ożarów Mazowiecki.
            </p>
          </div>

          <div className="rounded-3xl bg-[#e4e6d7] p-8">
            <ShoppingBag className="mb-5 h-8 w-8 text-[#1f3d2b]" />
            <h3 className="text-2xl font-semibold">Sklepy i usługi</h3>
            <p className="mt-3 leading-7 text-black/65">
              Infrastruktura potrzebna do codziennego funkcjonowania dostępna
              jest w miejscowościach gminy i w Ożarowie Mazowieckim.
            </p>
          </div>

          <div className="rounded-3xl bg-[#e4e6d7] p-8">
            <Trees className="mb-5 h-8 w-8 text-[#1f3d2b]" />
            <h3 className="text-2xl font-semibold">Spokojne otoczenie</h3>
            <p className="mt-3 leading-7 text-black/65">
              Sąsiedztwo zabudowy jednorodzinnej i terenów zielonych poza
              zwartą zabudową Warszawy.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Pogroszew – domy na terenie gminy Ożarów Mazowiecki
            </h2>

            <div className="mt-7 space-y-5 text-lg leading-8 text-black/65">
              <p>
                NovaDuo powstaje przy ul. Nowowiejskiej 58 w Pogroszewie, na
                działkach ewidencyjnych 24/8, 24/9, 24/11 i 24/12.
              </p>

              <p>
                Pogroszew jest miejscowością należącą do gminy Ożarów
                Mazowiecki. Inwestycja znajduje się poza centrum miasta, co
                pozwala zachować spokojniejszy charakter otoczenia.
              </p>

              <p>
                Jednocześnie mieszkańcy pozostają w zasięgu infrastruktury
                gminnej oraz tras prowadzących w kierunku Warszawy.
              </p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-[2rem] bg-white shadow-2xl">
            <iframe
              title="Lokalizacja domów NovaDuo w gminie Ożarów Mazowiecki"
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-2 lg:items-center">
          <div className="overflow-hidden rounded-[2rem] bg-white shadow-2xl">
            <img
              ...
              alt="Usytuowanie domów i lokali NovaDuo"
          ...
          <div>
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Wybierz dom dopasowany do potrzeb rodziny
            </h2>
      ...
      <section id="galeria" className="scroll-mt-36 mx-auto max-w-7xl px-6 py-20">
      ...
      >
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Domy NovaDuo w gminie Ożarów Mazowiecki
            </h2>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-[2rem] border border-[#1f3d2b]/10 bg-[#f6f3ec] p-8">
              <h2 className="text-2xl font-semibold">Segmenty pod Warszawą</h2>
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center font-medium text-[#1f3d2b]"
              >
                Zobacz stronę
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            ...
            <div className="rounded-[2rem] border border-[#1f3d2b]/10 bg-[#e4e6d7] p-8">
              <h2 className="text-2xl font-semibold">Segmenty Pogroszew</h2>
              <p className="mt-4 leading-7 text-black/65">
                Sprawdź szczegóły lokalizacji, parametry lokali i standard
                deweloperski NovaDuo.
              </p>
              <Link
            ...
            <div className="rounded-[2rem] border border-[#1f3d2b]/10 bg-[#f6f3ec] p-8">
              <h2 className="text-2xl font-semibold">Bliźniaki pod Warszawą</h2>
              <p className="mt-4 leading-7 text-black/65">
                Poznaj zalety budynków dwulokalowych z prywatnymi ogrodami i
                garażami.
              </p>
              <Link
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-2">
          <div>
            ...
            <h2 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Zapytaj o dom w gminie Ożarów Mazowiecki
            </h2>
          ...
          >
            <input
              type="hidden"
              name="source"
              value="Podstrona: domy Ożarów Mazowiecki"
            />
